...
All views will be created by traversing a graph of the portfolio in the memgraph database 
located at localhost port 7687.  
...
## Graph view 
Use the dash python package to display an interactive graph representing the portfolio.
